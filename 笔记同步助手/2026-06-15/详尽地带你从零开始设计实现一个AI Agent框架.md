...
author: 腾讯程序员
source: 微信公众号
url: https://mp.weixin.qq.com/s/YAGaXOWh2GBPSNsQt5SlJg
saved: 2026-06-15 15:51:27
tags:
  - 笔记同步助手
id: 2de0f30a-b5ef-464c-be38-4ed9320b4abe
---
...
![[笔记同步助手/images/a9abb66dd2173a6bf77f91f5ce618b00_MD5.png]]
...
![[笔记同步助手/images/220cd944a69ab0e679452f13f4e016f1_MD5.png]]
...
最早系统性的提出在Agent中引入反思概念的是[Noah Shinn、Shunyu Yao（](https://arxiv.org/abs/2303.11366)**[对，还是ReAct作者](https://arxiv.org/abs/2303.11366)**[）等的《Reflexion: Language Agents with Verbal Reinforcement Learning》论文](https://arxiv.org/abs/2303.11366)，论文里提出了Reflexion框架，通过语言反馈而非权重更新来强化语言Agent。Agent通过对任务反馈信号进行 口头反思，然后在情节记忆缓冲区中维护自己的反思文本，以在后续试验中做出更好的决策。
...
![[笔记同步助手/images/32017884c9c8f77b79878b0862fb301e_MD5.png]]
...
![[笔记同步助手/images/573042305d1f18ff493541503d4f420b_MD5.png]]
...
![[笔记同步助手/images/bebc90f38df66178afd4ca1e030a4b97_MD5.png]]
...
![[笔记同步助手/images/055158bfef9aec8b6948d66ebe154687_MD5.png]]

2）第2个问题

让它执行一个统计任务：帮我统计下当前目录下的代码行数以及token数

![[笔记同步助手/images/def861a7fea34762c213ae894b7cf8df_MD5.png]]

可以看到Agent Loop里在持续地调用Tools、写代码以及执行代码

![[笔记同步助手/images/9001f8dbc20098b62c9f41fbc0f1f0f8_MD5.png]]

最终的统计结果：

![[笔记同步助手/images/6057d8680b9bb04e31fa8008a5e20e28_MD5.png]]

做完任务，使用exit命令退出当前session

![[笔记同步助手/images/42e53b24ed05b0ebd40be3bc93401ceb_MD5.png]]
...
内容效果不满意？[点此反馈](https://feedback.notebooksyncer.com/feedback/a3ebc160_1781509883173?u=https%3A%2F%2Fmp.weixin.qq.com%2Fs%2FYAGaXOWh2GBPSNsQt5SlJg&s=obsidian)