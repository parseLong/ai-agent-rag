...
source: "https://mp.weixin.qq.com/s/2sNq-AMGP3CODOvkqxrb8w"
author:
  - "[[张小珺]]"
published:
created: 2026-05-20
...
tags:
  - "clippings"
---
张小珺 *2025年9月11日 17:55*

![[笔记同步助手/images/3b8ade61d4364604c9ae3a79636aafa5_MD5.webp|图片]]

作者：张小珺

2025年4月，OpenAI研究员姚顺雨发布了一篇有名的博文《The Second Half》，宣告AI主线程的游戏已进入下半场。这之后，我们与他进行了一场播客对谈。
...
此前，我们关于Manus肖宏、Youware明超平、Lovart陈冕的访谈，记录了华人Agent创业者在应用上的探索。而姚顺雨的访谈，描绘的则是另一面：他在硅谷最前沿的AI实验室做Agent研究，他如何看待这波浪潮、模型与应用的边界，以及那些Agent逐浪者呢？
...
- **我们也将推出本集的播客，在小宇宙、苹果** **Podcast** **、** **Spotify** **上线，相应视频在Bilibili上线。请搜索账号：张小珺商业访谈录。**
- **如果你喜爱我们的内容，请关注/点赞/推荐我们。（你的喜爱对我们来说，真的很重要！）**
...
我在2016年上李建老师的一门课，看到一个multi-modal embedding（多模态嵌入）的demo，展示了embedding（向量表示/嵌入）一个非常神奇的例子：比如用“king”的embedding减去“man”，再加上“queen”，结果接近“woman”的embedding——这让我第一次意识到，深度学习在语义表示上居然能做到这么惊艳的计算。
...
最初我做的是Computer Vision（计算机视觉），但渐渐意识到Vision很难实现通用人工智能。 **我的直觉告诉我：** **Language** **是一个更核心、更有潜力的方向，于是读博后转向语言模型研究。**
...
我遇到现在的导师KarthikNarasimhan（普林斯顿计算机科学副教授），开始一起头脑风暴项目点子。我当时说：现在的语言模型，比如GPT-2，已经比你们当年用的模型强太多，它们玩游戏是不是表现也会更好？
...
它某种程度上，是AI最重要的 *affordance* （环境给予行动者的可能性）。
...
在coding任务中，我们传统有一个评估指标叫Pass@k，意思是：你对同一个代码生成任务，最多尝试 *k* 次，其中起码有一次的成功概率是多少？你可以想象，当这个 *k* 越来越大，系统被使用的成功概率也会变大。
...
模型是可以（共享）的，但如果你讨论的是整个系统，那就不一样了。就像你问，这个世界上最强的互联网网站是什么？最强的互联网公司是什么？很难回答。它是一个multiface（多面向）的系统，有很多不同侧面。
