...
→ 详细分析见 [[Harness Engineering#三次进化的关系]] 和 [[Prompt与Context工程（三次进化）]]

---

## Mitchell Hashimoto 的起源故事

[[Harness Engineering#Mitchell Hashimoto 的采纳五阶段]]
...
[[Harness Engineering#Philipp Schmid 的操作系统类比]]
...
[[Harness Engineering#三层技术定义（arxiv 论文 2603.05344）]]
...
[[Harness Engineering#OpenAI 百万行代码实验]]
...
[[Harness Engineering#Stripe Minions]]
...
[[Harness Engineering#Cursor Self-Driving]]
...
[[Harness Engineering#数据对比：壳比模型值钱]]
...
[[Harness Engineering#拐杖论（Bitter Lesson 阵营）]]
...
- **核心概念**：[[Harness Engineering]]、[[Harness Engineering深度解析]]、[[Agent技术范式演变（2023-2026）]]
- **工程实践**：[[Prompt与Context工程（三次进化）]]、[[工程设计与安全]]、[[系统提示词工程]]
- **上下文工程**：[[Context Engineering]]、[[上下文注入]]、[[上下文压缩]]、[[上下文窗口管理]]
