...
tags: [概念卡片, 永久笔记, 概念, 智能体, 上下文工程, 提示工程, 驭驭工程, 三层Stack]
aliases:
  - 三层工程Stack
  - Prompt-Context-Harness Stack
  - 三层工程分工
date: 2026-06-11
source: "[[Stage 2 — 提示工程]], [[Stage 6 — 记忆与 RAG]], [[Stage 7 — 多智能体与生产部署]]"
---
...
| **2. [[上下文工程]]** | [[上下文窗口]]里装**什么信息**（RAG / memory / tool defs / history） | 这次该给模型哪些信息？ | Stage 6 |
...
> [[上下文工程]]是把**刚好对下一步有用的信息**填进[[上下文窗口]]的精细艺术。
...
> [[MCP]] 的特殊位置：MCP 严格说是[[上下文工程]]（feed context source）+ Tool design 跨层东西，标为 Layer 2.5。

## 🔑 怎么分辨自己在做哪一层？

1. 我改的是**字符串本身**吗？→ [[提示工程]]
2. 我改的是**塞进窗口的信息**吗？→ [[上下文工程]]
